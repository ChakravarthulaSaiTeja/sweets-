...
export const metadata: Metadata = {
  title: "About Us - Kotaiah's Foods",
  description:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <div className="space-y-4 text-[#8B1A1A]">
              <p>
                For over 124 years, Kotaiah&apos;s Foods has been the
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg p-3 shadow-lg">
              <div className="text-sm font-semibold text-[#8B1A1A]">Our Signature</div>
              <div className="text-xs text-[#8B1A1A]">Kakinada Kaja</div>
            </div>
          </div>
        </div>
        ...
        {/* Values Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-heading font-bold text-[#8B1A1A] mb-8 text-center">
            Our Values
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-[#8B1A1A]/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center">
              <div className="bg-[#D4AF37]/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">⭐</span>
              </div>
              <h3 className="text-xl font-semibold text-[#8B1A1A] mb-3">
                Quality
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="text-3xl mb-3">🥟</div>
              <h3 className="font-semibold text-[#8B1A1A] mb-2">Hot Snacks</h3>
              <p className="text-[#8B1A1A] text-sm">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="text-3xl mb-3">🎁</div>
              <h3 className="font-semibold text-[#8B1A1A] mb-2">Gift Boxes</h3>
              <p className="text-[#8B1A1A] text-sm">
        ...
        {/* Contact CTA */}
        <div className="bg-gradient-to-r from-[#8B1A1A] to-[#D4AF37] rounded-2xl p-8 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="bg-white text-[#8B1A1A] px-6 py-3 rounded-lg font-medium hover:bg-[#FFF7EE] transition-colors"
            >
              Shop Now
            </Link>
            <a
              href="/contact"
              className="border-2 border-white text-white px-6 py-3 rounded-lg font-medium hover:bg-white hover:text-[#8B1A1A] transition-colors"
            >
              Contact Us
            </a>
          </div>
