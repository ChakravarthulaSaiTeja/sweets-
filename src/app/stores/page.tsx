...
export const metadata: Metadata = {
  title: "Store Locator - Kotaiah's Foods",
  description: "Find Kotaiah's Foods stores near you. Visit our locations across Hyderabad and experience authentic Indian sweets.",
};
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#8B1A1A] max-w-2xl mx-auto">
            Find our stores near you and experience the authentic taste of Kotaiah&apos;s Foods
          </p>
        </div>
          ...
          {stores.map((store) => (
            <div
              ...
              className={`bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/30 transform hover:scale-105 transition-all duration-300 ${
                store.isMain ? "ring-2 ring-[#D4AF37]" : ""
              }`}
            >
              {store.isMain && (
                <div className="bg-gradient-to-r from-[#8B1A1A] to-[#D4AF37] text-white px-4 py-2 rounded-full text-sm font-semibold mb-4 inline-block">
                  Main Store
                </div>
              )}
              
              <h3 className="text-2xl font-heading font-bold text-[#8B1A1A] mb-4">
                {store.name}
              </h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-[#8B1A1A] text-sm leading-relaxed">
                    {store.address}
                  </span>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a
                    ...
                    className="text-[#8B1A1A] hover:text-[#8B1A1A] transition-colors duration-200"
                  >
                    {store.phone}
                  </a>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-[#8B1A1A] text-sm">
                    {store.hours}
                  </span>
                </div>
              </div>

              <div className="mt-6 pt-6 border-t border-[#fff9e6]">
                <a
                  href={`https://maps.google.com/?q=${encodeURIComponent(store.address)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-gradient-to-r from-[#8B1A1A] to-[#D4AF37] text-white py-3 px-6 rounded-xl font-semibold hover:from-[#D4AF37] hover:to-[#8B1A1A] transition-all duration-300 text-center block"
                >
                  Get Directions
                </a>
              </div>
        ...
        <div className="mt-16 bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/30">
          <div className="text-center">
            ...
            <p className="text-[#8B1A1A] text-lg mb-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/products"
                className="bg-gradient-to-r from-[#8B1A1A] to-[#D4AF37] text-white px-8 py-3 rounded-xl font-semibold hover:from-[#D4AF37] hover:to-[#8B1A1A] transition-all duration-300"
              >
                Order Online
              </Link>
              <a
                href="/contact"
                className="border-2 border-[#8B1A1A] text-[#8B1A1A] px-8 py-3 rounded-xl font-semibold hover:bg-[#8B1A1A] hover:text-white transition-all duration-300"
              >
                Contact Us
              </a>
            </div>
