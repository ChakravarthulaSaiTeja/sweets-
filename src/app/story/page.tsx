...
export const metadata: Metadata = {
  title: "Our Story - Kotaiah's Foods",
  description: "Discover the rich heritage and tradition behind Kotaiah's Foods, serving authentic Indian sweets since 1900.",
};
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl border border-white/30">
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-[#8B1A1A] leading-relaxed">
                  Over the years, Kotaiah&apos;s Foods has been passed down through four generations of 
              ...
              <div>
                ...
                <p className="text-[#8B1A1A] leading-relaxed">
                  ...
                  just buying sweets &ndash; you&apos;re becoming part of our family&apos;s legacy.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#8B1A1A] to-[#D4AF37] rounded-2xl p-8 text-white text-center">
                ...
                <Link
                  href="/products"
                  className="inline-block bg-white text-[#8B1A1A] px-8 py-3 rounded-xl font-semibold hover:bg-[#FFF7EE] transition-colors duration-300"
                >
                  Explore Our Sweets
                </Link>
              </div>
