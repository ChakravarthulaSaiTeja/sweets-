...
import { Mail, Phone, ArrowLeft, Sparkles, Heart, Star, Cookie, Candy } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await signIn("credentials", {
        email: emailOrPhone,
        password: "magic-link", // Placeholder for magic link
        redirect: false,
      });
        ...
        <div className="text-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-xl font-medium">
              Sign in to your Kotaiah&apos;s Sweets account
            </p>
