...
export const metadata: Metadata = {
  title: "Shipping Information - Kotaiah's Foods",
  description: "Learn about our shipping policies, delivery areas, and estimated delivery times for Kotaiah's Foods orders.",
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {shippingInfo.map((item, index) => (
            <div key={index} className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/30 text-center">
              <item.icon className="h-16 w-16 text-[#D4AF37] mx-auto mb-6" />
              <h3 className="text-2xl font-semibold text-[#8B1A1A] mb-4">
                {item.title}
              </h3>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#FFF7EE] rounded-xl p-6">
                  <h3 className="text-xl font-semibold text-[#8B1A1A] mb-3">Surrounding Areas</h3>
                  <ul className="space-y-2 text-sm text-[#8B1A1A]">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-[#8B1A1A] mb-2">Order Confirmation</h3>
                  <p className="text-[#8B1A1A] text-sm">We confirm your order and prepare it fresh</p>
                </div>
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-[#8B1A1A] mb-2">Packaging</h3>
                  <p className="text-[#8B1A1A] text-sm">Carefully package your sweets for safe delivery</p>
                </div>
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-[#8B1A1A] mb-2">Delivery</h3>
                  <p className="text-[#8B1A1A] text-sm">Deliver to your doorstep with tracking updates</p>
                </div>
              </div>
            </div>
